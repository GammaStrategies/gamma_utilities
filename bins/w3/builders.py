...
def build_hypervisor(
    ...
    if protocol == Protocol.UNISWAPv3:
    ...
    elif protocol == Protocol.QUICKSWAP_UNISWAP:
        # this is quickswap present in a chain with uniswap v3 ( this ) and algebra pools ( quickswap protocol name )
        hypervisor = (
            protocols.quickswap.hypervisor_unialgeb.gamma_hypervisor(
                address=hypervisor_address,
                network=network,
                block=block,
                timestamp=timestamp,
            ...
            if not cached and not multicall
                ...
                protocols.quickswap.hypervisor_unialgeb.gamma_hypervisor_cached(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
                ...
                if not multicall
                else protocols.quickswap.hypervisor_unialgeb.gamma_hypervisor_multicall(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
        ...
        hypervisor = (
            protocols.pegasys.hypervisor.gamma_hypervisor(
                address=hypervisor_address,
                network=network,
                block=block,
                timestamp=timestamp,
    ...
    elif protocol == Protocol.APERTURE:
        hypervisor = (
            protocols.aperture.hypervisor.gamma_hypervisor(
                address=hypervisor_address,
                network=network,
                block=block,
                timestamp=timestamp,
            ...
            if not cached and not multicall
                ...
                protocols.aperture.hypervisor.gamma_hypervisor_cached(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
                ...
                if not multicall
                else protocols.aperture.hypervisor.gamma_hypervisor_multicall(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
    ...
    elif protocol == Protocol.THICK:
        hypervisor = (
            protocols.thick.hypervisor.gamma_hypervisor(
                address=hypervisor_address,
                network=network,
                block=block,
                timestamp=timestamp,
            ...
            if not cached and not multicall
                ...
                protocols.thick.hypervisor.gamma_hypervisor_cached(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
                ...
                if not multicall
                else protocols.thick.hypervisor.gamma_hypervisor_multicall(
                    address=hypervisor_address,
                    network=network,
                    block=block,
                    timestamp=timestamp,
...
def build_protocol_pool(
    ...
    if protocol == Protocol.UNISWAPv3:
        ...
        return (
            ...
            if not cached
            else protocols.basex.pool.pool_cached(
                address=pool_address,
                network=chain.database_name,
                block=block,
                timestamp=timestamp,

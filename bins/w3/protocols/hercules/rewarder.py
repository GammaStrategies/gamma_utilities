...
# TODO: remove when coded
# #################################################################


class hercules_rewards_nft_pool_master(web3wrap):
    #
    def __init__(
        self,
        address: str,
    ...
    def get_all_rewards_info(self, chain: Chain):
        ...
        nftPool_abi_part = hercules_rewards_nft_pool(
...
# --- NFT
class hercules_rewards_nft_pool_factory(web3wrap):
    #
    def __init__(
        self,
        address: str,
...
class hercules_rewards_nft_pool(web3wrap):
    #
    def __init__(
        self,
        address: str,
...
# --- NITRO
class hercules_rewards_nitro_pool_factory(web3wrap):
    #
    ...
    def get_all_rewards_info(self, chain: Chain, nft_pools: list[str]):
        ...
        nitro_pool_helper = hercules_rewards_nitro_pool(
            address="0x0000000000000000000000000000000000000000",
            network=chain.database_name,
            block=self.block,
            timestamp=self._timestamp,
...
class hercules_rewards_nitro_pool(web3wrap):

...
class thegraph_scraper_helper():
    ...
    def __init__(self, cache:bool=True, cache_savePath:str="", convert=True):
        ...
        if cache:
            ...
            self._CACHE = cache_utilities.standard_thegraph_cache(filename=self.__class__.__name__, folder_name=cache_savePath)
...
class gamma_scraper(thegraph_scraper_helper):
    ...
    __URLS = {"ethereum":"https://api.thegraph.com/subgraphs/name/gammastrategies/gamma",
    ...
    __URLS_messari = {"ethereum":"https://api.thegraph.com/subgraphs/name/messari/gamma-ethereum",
    ...
    def _query_constructor(self, skip:int, name:str, filter:str)->tuple:
        ...
        if name == "uniswapV3Hypervisors":
            return """
                ...
                """.format(filter,skip), ["data","uniswapV3Hypervisors"]
            ...
            return """
                ...
                """.format(filter,skip), ["data","uniswapV3Deposits"]
            ...
            return """
                ...
                """.format(filter,skip), ["data","uniswapV3Withdraws"]
            ...
            return """{{
                ...
                """.format(filter,skip), ["data","uniswapV3Rebalances"]
            ...
            {{  accounts({}, skip: {}) {{
                ...
                """.format(filter,skip), ["data","accounts"]
            ...
            return """{{ uniswapV3Pools({}, skip: {}) {{
                    ...
                    }}""".format(filter,skip), ["data","uniswapV3Pools"]
            ...
            return """ {{
                ...
                """.format(filter,skip), ["data","uniswapV3HypervisorConversions"]
            ...
            logging.getLogger(__name__).error("No query found with name {}".format(name))
            raise NotImplementedError("No gamma query constructor found for: {} ".format(name))
        #except:
    ...
    def _converter(self, itm:dict, query_name:str, network:str):
        ...
        if query_name == "uniswapV3Hypervisors":
            ...
            itm["baseFeeGrowthInside0LastRebalanceX128"] = int(itm["baseFeeGrowthInside0LastRebalanceX128"])
            itm["baseFeeGrowthInside0LastX128"] = int(itm["baseFeeGrowthInside0LastX128"])
            itm["baseFeeGrowthInside1LastRebalanceX128"] = int(itm["baseFeeGrowthInside1LastRebalanceX128"])
            itm["baseFeeGrowthInside1LastX128"] = int(itm["baseFeeGrowthInside1LastX128"])
            itm["baseLiquidity"] = int(itm["baseLiquidity"])
            itm["limitFeeGrowthInside0LastX128"] = int(itm["limitFeeGrowthInside0LastX128"])
            itm["limitFeeGrowthInside0LastRebalanceX128"] = int(itm["limitFeeGrowthInside0LastRebalanceX128"])
            itm["limitFeeGrowthInside1LastRebalanceX128"] = int(itm["limitFeeGrowthInside1LastRebalanceX128"])
            itm["limitFeeGrowthInside1LastX128"] = int(itm["limitFeeGrowthInside1LastX128"])
            ...
            itm["hypervisor"]["feesReinvested0"] = int(itm["hypervisor"]["feesReinvested0"])/c0
            itm["hypervisor"]["feesReinvested1"] = int(itm["hypervisor"]["feesReinvested1"])/c1
            itm["hypervisor"]["feesReinvestedUSD"] = float(itm["hypervisor"]["feesReinvestedUSD"])
            itm["hypervisor"]["grossFeesClaimed0"] = int(itm["hypervisor"]["grossFeesClaimed0"])/c0
            itm["hypervisor"]["grossFeesClaimed1"] = int(itm["hypervisor"]["grossFeesClaimed1"])/c1
            itm["hypervisor"]["grossFeesClaimedUSD"] = float(itm["hypervisor"]["grossFeesClaimedUSD"])
            itm["hypervisor"]["protocolFeesCollected0"] = int(itm["hypervisor"]["protocolFeesCollected0"])/c0
            itm["hypervisor"]["protocolFeesCollected1"] = int(itm["hypervisor"]["protocolFeesCollected1"])/c1
            itm["hypervisor"]["protocolFeesCollectedUSD"] = float(itm["hypervisor"]["protocolFeesCollectedUSD"])
            itm["hypervisor"]["lastUpdated"] = dt.datetime.fromtimestamp(int(itm["hypervisor"]["lastUpdated"]))
            itm["hypervisor"]["created"] = dt.datetime.fromtimestamp(int(itm["hypervisor"]["created"]))
            itm["hypervisor"]["pricePerShare"] = float(itm["hypervisor"]["pricePerShare"])
            itm["hypervisor"]["totalSupply"] = int(itm["hypervisor"]["totalSupply"])/(10**18)
            ...
            itm["hypervisor"]["baseFeeGrowthInside0LastRebalanceX128"] = int(itm["hypervisor"]["baseFeeGrowthInside0LastRebalanceX128"])
            itm["hypervisor"]["baseFeeGrowthInside0LastX128"] = int(itm["hypervisor"]["baseFeeGrowthInside0LastX128"])
            itm["hypervisor"]["baseFeeGrowthInside1LastRebalanceX128"] = int(itm["hypervisor"]["baseFeeGrowthInside1LastRebalanceX128"])
            itm["hypervisor"]["baseFeeGrowthInside1LastX128"] = int(itm["hypervisor"]["baseFeeGrowthInside1LastX128"])

            itm["hypervisor"]["conversion"]["priceBaseInUSD"] = float(itm["hypervisor"]["conversion"]["priceBaseInUSD"])
            itm["hypervisor"]["conversion"]["priceTokenInBase"] = float(itm["hypervisor"]["conversion"]["priceTokenInBase"])
            ...
            try:
                ...
                itm["gammaEarnedRealized"] = float(int(itm["gammaEarnedRealized"])/(10**18))
            except:
                logging.getLogger(__name__).exception("Unexpected error while converting  accounts gamma info for item  {}        .error: {}".format(itm["id"], sys.exc_info()[0]))
            ...
            for hyp_share in itm["hypervisorShares"]:
                try:
                    ...
                    hyp_share["hypervisor"]["totalSupply"] = int(hyp_share["hypervisor"]["totalSupply"])/(10**18)
                    hyp_share["hypervisor"]["created"] = dt.datetime.fromtimestamp(int(hyp_share["hypervisor"]["created"]))
                    hyp_share["hypervisor"]["lastUpdated"] = dt.datetime.fromtimestamp(int(hyp_share["hypervisor"]["lastUpdated"]))

                    hyp_share["hypervisor"]["tvl0"] = int(hyp_share["hypervisor"]["tvl0"])/c0
                    hyp_share["hypervisor"]["tvl1"] = int(hyp_share["hypervisor"]["tvl1"])/c1
                    hyp_share["hypervisor"]["tvlUSD"] = float(hyp_share["hypervisor"]["tvlUSD"])

                    hyp_share["hypervisor"]["feesReinvested0"] = int(hyp_share["hypervisor"]["feesReinvested0"])/c0
                    hyp_share["hypervisor"]["feesReinvested1"] = int(hyp_share["hypervisor"]["feesReinvested1"])/c1
                    hyp_share["hypervisor"]["feesReinvestedUSD"] = float(hyp_share["hypervisor"]["feesReinvestedUSD"])

                    hyp_share["hypervisor"]["grossFeesClaimed0"] = int(hyp_share["hypervisor"]["grossFeesClaimed0"])/c0
                    hyp_share["hypervisor"]["grossFeesClaimed1"] = int(hyp_share["hypervisor"]["grossFeesClaimed1"])/c1
                    hyp_share["hypervisor"]["grossFeesClaimedUSD"] = float(hyp_share["hypervisor"]["grossFeesClaimedUSD"])

                    hyp_share["hypervisor"]["conversion"]["priceBaseInUSD"] = float(hyp_share["hypervisor"]["conversion"]["priceBaseInUSD"])
                    hyp_share["hypervisor"]["conversion"]["priceTokenInBase"] = float(hyp_share["hypervisor"]["conversion"]["priceTokenInBase"])

                    hyp_share["hypervisor"]["baseTokensOwed0"] = int(hyp_share["hypervisor"]["baseTokensOwed0"])/c0
                    hyp_share["hypervisor"]["baseTokensOwed1"] = int(hyp_share["hypervisor"]["baseTokensOwed1"])/c1
                    hyp_share["hypervisor"]["limitTokensOwed0"] = int(hyp_share["hypervisor"]["limitTokensOwed0"])/c0
                    hyp_share["hypervisor"]["limitTokensOwed1"] = int(hyp_share["hypervisor"]["limitTokensOwed1"])/c1

                    hyp_share["hypervisor"]["baseFeeGrowthInside0LastRebalanceX128"] = int(hyp_share["hypervisor"]["baseFeeGrowthInside0LastRebalanceX128"])
                    hyp_share["hypervisor"]["baseFeeGrowthInside0LastX128"] = int(hyp_share["hypervisor"]["baseFeeGrowthInside0LastX128"])
                    hyp_share["hypervisor"]["baseFeeGrowthInside1LastRebalanceX128"] = int(hyp_share["hypervisor"]["baseFeeGrowthInside1LastRebalanceX128"])
                    hyp_share["hypervisor"]["baseFeeGrowthInside1LastX128"] = int(hyp_share["hypervisor"]["baseFeeGrowthInside1LastX128"])
                    hyp_share["hypervisor"]["baseLiquidity"] = int(hyp_share["hypervisor"]["baseLiquidity"])
                    hyp_share["hypervisor"]["limitFeeGrowthInside0LastX128"] = int(hyp_share["hypervisor"]["limitFeeGrowthInside0LastX128"])
                    hyp_share["hypervisor"]["limitFeeGrowthInside0LastRebalanceX128"] = int(hyp_share["hypervisor"]["limitFeeGrowthInside0LastRebalanceX128"])
                    hyp_share["hypervisor"]["limitFeeGrowthInside1LastRebalanceX128"] = int(hyp_share["hypervisor"]["limitFeeGrowthInside1LastRebalanceX128"])
                    hyp_share["hypervisor"]["limitFeeGrowthInside1LastX128"] = int(hyp_share["hypervisor"]["limitFeeGrowthInside1LastX128"])
                    hyp_share["hypervisor"]["limitLiquidity"] = int(hyp_share["hypervisor"]["limitLiquidity"])
                
                except:
                    logging.getLogger(__name__).exception("Unexpected error while converting  hypervisorShares of item  {}        .error: {}".format(itm["id"], sys.exc_info()[0]))
        
            for hyp_mast in itm["masterChefPoolAccounts"]:
                # prepare
                hyp_mast["masterChefPool"]["stakeToken"]["decimals"]= int(hyp_mast["masterChefPool"]["stakeToken"]["decimals"])
                c = 10**int(hyp_mast["masterChefPool"]["stakeToken"]["decimals"])

                hyp_mast["masterChefPool"]["allocPoint"] = int(hyp_mast["masterChefPool"]["allocPoint"])
                hyp_mast["masterChefPool"]["masterChef"]["totalAllocPoint"] = int(hyp_mast["masterChefPool"]["masterChef"]["totalAllocPoint"])
                hyp_mast["shares"] = int(hyp_mast["amount"])/int(hyp_mast["masterChefPool"]["totalStaked"])
                hyp_mast["amount"] = int(hyp_mast["amount"])/c
                hyp_mast["masterChefPool"]["totalStaked"] = int(hyp_mast["masterChefPool"]["totalStaked"])/c
                
            for hyp_re in itm["rewardHypervisorShares"]:
                hyp_re["rewardHypervisor"]["totalGamma"] = int( hyp_re["rewardHypervisor"]["totalGamma"])
                hyp_re["rewardHypervisor"]["totalSupply"] = int(hyp_re["rewardHypervisor"]["totalSupply"])/(10**18)
            ...
            logging.getLogger(__name__).error("No converter found with name {}".format(query_name))
            raise NotImplementedError("No gamma converter found for: {} ".format(query_name))
...
class arrakis_scraper(thegraph_scraper_helper):
    ...
    __URLS = {"ethereum":"https://api.thegraph.com/subgraphs/name/arrakisfinance/vault-v1-mainnet",
              "optimism":"https://api.thegraph.com/subgraphs/name/arrakisfinance/vault-v1-optimism",
        }
    __URLS_gelato = {"ethereum":"https://api.thegraph.com/subgraphs/name/gelatodigital/g-uni",}
    __URLS_messari = {"ethereum":"https://api.thegraph.com/subgraphs/name/messari/arrakis-finance-ethereum",
    ...
    def _query_constructor(self, skip:int, name:str, filter:str):
        ...
        if name == "vaults":
            ...
            """.format(filter, skip),["data","vaults"]
            ...
            """.format(filter, skip),["data","vaults",0, "snapshots"]
            ...
            """.format(filter, skip),["data","vaults",0, "reranges"]
            ...
            """.format(filter, skip),["data","aprSnapshots"]
        ...
        # gelato: 
            ...
            """.format(filter, skip),["data","pools",0, "supplySnapshots"]
            ...
            return """{{
             ...
             """.format(filter, skip), ["data","pools",0, "feeSnapshots"]
        ...
        # messari: 
            ...
            return """ {{
                ...
                """.format(filter, skip),["data","underlyingTokens"]
            ...
            return """ {{
                ...
                """.format(filter, skip),["data","feesEarneds"]
            ...
            return """ {{
                ...
                """.format(filter, skip),["data","withdraws"]
            ...
            return """ {{
                ...
                """.format(filter, skip),["data","deposits"]
            ...
            return """ {{
                ...
                """.format(filter, skip),["data","vaultHourlySnapshots"]
        else:
            logging.getLogger(__name__).error("No query found with name {}".format(name))
            raise NotImplementedError("No arrakis query constructor found for: {} ".format(name))
    ...
    def _converter(self, itm:dict, query_name:str, network:str):
        ...
        if query_name == "vaults":
            ...
            itm["feeInfo"]["checkpointTimestamp"] = int(itm["feeInfo"]["checkpointTimestamp"] )
            itm["feeInfo"]["collect0"] = int(itm["feeInfo"]["collect0"])/c0
            itm["feeInfo"]["collect1"] = int(itm["feeInfo"]["collect1"])/c1
            itm["feeInfo"]["feeCheckpoint0"] = int(itm["feeInfo"]["feeCheckpoint0"])/c0
            itm["feeInfo"]["feeCheckpoint1"] = int(itm["feeInfo"]["feeCheckpoint1"])/c1
            ...
            if len(itm["snapshots"]) == 1000:        
                # get extra snapshots
                logging.getLogger(__name__).debug("getting extra snapshots for {}  vault id: {}  network:{}".format(itm["name"], itm["id"], network))
                whr_snap = """ id: "{}" """.format(itm["id"])
                # get all snapshors and convert subitems here
                tmp_raw_snapshots = self.get_all_results(network=network, query_name=query_name+"_snapshots", where=whr_snap, skip=1000)
            ...
            if len(itm["reranges"]) == 1000:            
                # get extra snapshots
                logging.getLogger(__name__).debug("getting extra reranges for {}  vault id: {} network:{}".format(itm["name"], itm["id"], network))
                whr_snap = """ id: "{}" """.format(itm["id"])
                itm["reranges"] += self.get_all_results(network=network, query_name=query_name+"_reranges", where=whr_snap, skip=1000) #[0]["reranges"]
        ...
        # gelato
            ...
            itm["latestInfo"]["unclaimedFees0"] = int(itm["latestInfo"]["unclaimedFees0"])/c0
            itm["latestInfo"]["unclaimedFees1"] = int(itm["latestInfo"]["unclaimedFees1"])/c1
            ...
            if len(itm["supplySnapshots"]) == 1000:            
                # get extra snapshots
                logging.getLogger(__name__).debug("getting extra supply snapshots for {}  vault id: {}  network:{}".format(itm["name"], itm["id"], network))
                whr_snap = """ id: "{}" """.format(itm["id"]) 
                itm["supplySnapshots"] += self.get_all_results(network=network, query_name=query_name+"_supplysnapshots", where=whr_snap, skip=1000)
            ...
            if len(itm["feeSnapshots"]) == 1000:            
                # get extra snapshots
                logging.getLogger(__name__).debug("getting extra fee snapshots for {}  vault id: {} network:{}".format(itm["name"], itm["id"], network))
                whr_snap = """ id: "{}" """.format(itm["id"])
                itm["feeSnapshots"] += self.get_all_results(network=network, query_name=query_name+"_feesnapshots", where=whr_snap, skip=1000)
        elif query_name == "pools_gelato_supplysnapshots":
            raise NotImplemented(" pools_gelato_supplysnapshots has to be reimplemented ")
            itm["block"] = int(itm["block"])
        ...
        # messari
            ...
            itm["outputTokenSupply"] = int(itm["outputTokenSupply"])/(10**itm["outputToken"]["decimals"])
            itm["inputTokenBalance"] = int(itm["inputTokenBalance"])/(10**itm["inputToken"]["decimals"])
            ...
            itm["asset"]["lastPriceBlockNumber"] = int(itm["asset"]["lastPriceBlockNumber"])

            itm["vault"]["totalValueLockedUSD"] = float(itm["vault"]["totalValueLockedUSD"])
            ...
            itm["cumulativeProtocolSideRevenueUSD"] = float(itm["cumulativeProtocolSideRevenueUSD"])
            itm["cumulativeSupplySideRevenueUSD"] = float(itm["cumulativeSupplySideRevenueUSD"])
            itm["cumulativeTotalRevenueUSD"] = float(itm["cumulativeTotalRevenueUSD"])
            itm["hourlyProtocolSideRevenueUSD"] = float(itm["hourlyProtocolSideRevenueUSD"])
            ...
            raise NotImplementedError("No arrakis converter found for: {} ".format(query_name))
...
class xtoken_scraper(thegraph_scraper_helper):
    ...
    __URLS = {"ethereum":"https://api.thegraph.com/subgraphs/name/xtokenmarket/terminal-mainnet",
    ...
    def _query_constructor(self, skip:int, name:str, filter:str):
        ...
        if name == "pools":
            ...
            return """ {{
                ...
                """.format(filter, skip), ["data","withdrawals"]
        elif name == "collects":
            return """ {{
                        collects({}, skip: {}) {{
                                token0Fee
                ...
                """.format(filter, skip), ["data","collects"]
        elif name == "uniswaps":
            return """{{
                        uniswaps({}, skip: {}) {{ 
                            id
                ...
                """.format(filter,skip), ["data","uniswaps"]
        elif name == "users":
            return """{{
                        users({}, skip: {}) {{ 
                            id
    ...
    def _converter(self, itm:dict, query_name:str, network:str):
        ...
        if query_name == "pools":
            ...
            logging.getLogger(__name__).error("No converter found with name {}".format(query_name))
            raise ValueError("No xtoken query converter found for: {} ".format(query_name))
...
class uniswapv3_scraper(thegraph_scraper_helper):
    ...
    __URLS = {"ethereum":"https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v3",
    ...
    def _converter(self, itm:dict, query_name:str, network:str):
        ...
        if query_name == "pools":
            ...
            itm["liquidity"] = int(itm["liquidity"])
            itm["createdAtTimestamp"] = dt.datetime.fromtimestamp(int(itm["createdAtTimestamp"]))
            ...
            itm["tickLower"]["feeGrowthOutside0X128"] = int(itm["tickLower"]["feeGrowthOutside0X128"])
            itm["tickLower"]["feeGrowthOutside1X128"] = int(itm["tickLower"]["feeGrowthOutside1X128"])
            ...
            itm["tickUpper"]["feeGrowthOutside0X128"] = int(itm["tickUpper"]["feeGrowthOutside0X128"])
...
class blocks_scraper(thegraph_scraper_helper):
    ...
    __URLS = {"ethereum":"https://api.thegraph.com/subgraphs/name/blocklytics/ethereum-blocks",
    ...
    def _query_constructor(self, skip:int, name:str, filter:str):
        ...
        if name == "blocks":
            return """{{blocks({}, skip: {}) {{
                    ...
                    }}""".format(filter, skip), ["data","blocks"]

        else:
            logging.getLogger(__name__).error("No block query found with name {}".format(name))
    ...
    def _converter(self, itm:dict, query_name:str, network:str):
        ...
        if query_name == "blocks":
            ...
            logging.getLogger(__name__).error("No block converter found with name {}".format(query_name))
            raise ValueError("No block query converter found for: {} ".format(query_name))
